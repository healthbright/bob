...
class TestPreCompactHook:
    ...
    @patch("os.environ", {"BOB_SESSION_ID": "test123"})
...
class TestCaptureTaskList:
    ...
    def test_returns_none_when_no_session_id(self):
        """Should return None when BOB_SESSION_ID is not set."""
        from pre_compact import _capture_task_list

        with patch.dict(os.environ, {"BOB_SESSION_ID": ""}, clear=False):
    ...
    def test_returns_none_when_tasks_dir_missing(self, tmp_path):
        ...
        with patch.dict(os.environ, {"BOB_SESSION_ID": "99999"}, clear=False):
            result = _capture_task_list()

"""SessionStart(compact) hook - restore Bob context after compaction.

Fires after Claude Code compaction completes to re-inject Bob-specific context
...
def _format_context_message(plan_data: dict | None, fallback_state: dict | None) -> str:
    ...
    lines = ["[Bob Context Restored After Compaction]"]

...
|-------------|-----------------|--------------|
| `{slug}-project.md` | Tech stack, structure, commands, architecture | References to `~/.claude/`, Pilot-specific tooling |
...
- References to `~/.claude/` directories or Pilot-specific tooling
- Claude-specific MCP invocation syntax (`ToolSearch`, `mcp__plugin_pilot_*` tool names)

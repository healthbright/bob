...
**Only if nested directories exist** (detected in Phase 1 step 6) **or are being created in this sync.**
...
> Auto-generated by `/sync` on [Date]. Describes how rules are organized.

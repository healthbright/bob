...
Smart model switching handles this routing automatically in most cases. But if you are explicitly choosing a model for a complex task, reach for Sonnet or [Opus](/blog/choosing-the-right-claude-model).
...
- [Usage optimization](/blog/usage-optimization) for managing Claude Code costs

Last updated on

[Previous

Sonnet 4.5](/blog/claude-sonnet-4-5)[Next

Opus 4.1](/blog/claude-opus-4-1)

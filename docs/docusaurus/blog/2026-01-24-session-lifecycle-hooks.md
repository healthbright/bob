...
Use PreCompact with SessionStart for context recovery. See the [Context Recovery Hook](/blog/context-recovery-hook) for the complete pattern.
...
- Explore [Skill Activation](/blog/skill-activation-hook) for automatic skill loading

Last updated on

[Previous

Self-Validating Agents](/blog/self-validating-agents)[Next

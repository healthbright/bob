...
[Planning mode](/blog/planning-modes) (`Shift+Tab` twice) changes how Claude approaches problems. Run this comparison:
...
Your [CLAUDE.md file](/blog/claude-md-mastery) directly shapes Claude's behavior. Test different configurations:
...
1. **[Context management](/blog/context-management)**: What happens at 60% vs 90% context usage?
2. **[Auto-planning](/blog/auto-planning-strategies)**: Does automated planning outperform manual mode switching?
3. **[Model selection](/blog/choosing-the-right-claude-model)**: How do different models handle the same complex task?
...
This experimentation approach is what we call the "system evolution mindset." It's one of [5 Claude Code best practices](/blog/agentic-engineering-best-practices) that separate top developers from everyone else.

Last updated on

[Previous

Auto-Planning Strategies](/blog/auto-planning-strategies)[Next

Context Management](/blog/context-management)

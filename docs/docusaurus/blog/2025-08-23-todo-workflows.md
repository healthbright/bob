...
> **Update (Jan 2025)**: Claude Code now has a more powerful [task management system](/blog/task-management) with dependencies, blockers, and multi-session collaboration. The fundamentals below still apply, but see the new guide for advanced workflows.
...
**Claude skips todos**: Add "Check todo list before starting each step" to your [CLAUDE.md file](/blog/claude-md-mastery).
...
- Learn about [git integration patterns](/blog/git-integration) for todo-driven commits
- Master [feedback loops](/blog/feedback-loops) to iterate on todo quality
- Check out [permission management](/blog/permission-management) for secure todo execution
- Explore [planning modes](/blog/planning-modes) for structured todo creation
- Review [context management](/blog/context-management) to maintain todo history

Last updated on

[Previous

Feedback Loops](/blog/feedback-loops)[Next

Task Management](/blog/task-management)

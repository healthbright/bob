...
This transforms sub-agents from blocking operations into true parallel workflows. For the complete async workflow guide, see [Background Agents & Parallel Execution](/blog/async-workflows).
...
- **Execution patterns**: Learn [when to use parallel, sequential, or background](/blog/sub-agent-best-practices) for optimal results
- **Foundation**: Start with [Agent Fundamentals](/blog/agent-fundamentals) to understand the basics
- **Implementation**: Practice with [Custom Agents](/blog/custom-agents) for specialized scenarios
- **Coordination**: Learn [Task Distribution](/blog/task-distribution) for complex project management
- **Optimization**: Explore [Planning Modes](/blog/planning-modes) for safe sub-agent execution
- **Context Management**: Master [Context Preservation](/blog/context-preservation) to maintain quality across agents
...
Sub-Agent Patterns](/blog/sub-agent-best-practices)[Next

Task Distribution](/blog/task-distribution)

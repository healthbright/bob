...
4. **Add server instructions**: Include descriptive instructions for [MCP Tool Search](/blog/mcp-tool-search) compatibility
5. **Learn more**: Check our [MCP basics guide](/blog/mcp-basics) and [popular MCP servers](/blog/best-addons)
...
Social Media MCPs](/blog/social-media-mcps)[Next

Claude Code VS Code](/blog/claude-code-vscode)

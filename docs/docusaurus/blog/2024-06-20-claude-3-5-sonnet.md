...
The original 3.5 Sonnet was replaced by an [upgraded version in October 2024](/blog/claude-3-5-sonnet-v2) that brought further improvements and the groundbreaking Computer Use feature.

## [Navigation](#navigation)

- [All Claude Models](/blog) for the complete model index
- [Claude 3](/blog/claude-3), the predecessor family
- [Claude 3.5 Sonnet v2](/blog/claude-3-5-sonnet-v2), the October 2024 upgrade with Computer Use

Last updated on

[Previous

Claude 3.5 Sonnet v2](/blog/claude-3-5-sonnet-v2)[Next

Claude 3](/blog/claude-3)

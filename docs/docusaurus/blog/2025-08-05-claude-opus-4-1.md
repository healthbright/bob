...
Opus 4.1 has been superseded by [Opus 4.5](/blog/claude-opus-4-5), which brought dramatic cost reductions and token efficiency improvements. Opus 4.1 remains an important stepping stone in the model timeline, but there is no practical reason to select it over the current [Opus generation](/blog/choosing-the-right-claude-model).

## [Related Pages](#related-pages)

- [All Claude Models](/blog) for the complete model timeline
- [Claude 4 family](/blog/claude-4) for the generation overview
- [Sonnet 4.5](/blog/claude-sonnet-4-5) for the next major release
...
Haiku 4.5](/blog/claude-haiku-4-5)[Next

Claude 4](/blog/claude-4)

...
- [Claude 3.5 Sonnet](/blog/claude-3-5-sonnet), the next release that surpassed Opus at a fraction of the cost
- [Model selection strategies](/blog/choosing-the-right-claude-model) for choosing the right model for your workload

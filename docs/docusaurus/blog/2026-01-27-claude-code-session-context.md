...
Start simple. If you find yourself needing deterministic scripts, installation automation, or agent oversight during setup, move to [setup hooks](/blog/claude-code-setup-hooks). But for context loading, a slash command is often all you need.

Last updated on

[Previous

Claude Skills Guide](/blog/claude-skills-guide)[Next

...
**Pro tip**: Edit the generated CLAUDE.md to add your preferences. Claude reads this file at session start, so your conventions persist across every future session. Learn more in our [CLAUDE.md Mastery guide](/blog/claude-md-mastery).
...
Fix: Check that your CLAUDE.md is in the project root. Claude only reads it from the current working directory. See [context management](/blog/context-management) for more details.
...
- Check out [Git Integration](/blog/git-integration) for version control with Claude
- Master [Feedback Loops](/blog/feedback-loops) for rapid iteration
- Explore [Efficiency Patterns](/blog/efficiency-patterns) to speed up your workflow

Last updated on

[Previous

Task Management](/blog/task-management)[Next

Usage Optimization](/blog/usage-optimization)

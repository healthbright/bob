...
**New to Claude Code?** Follow the [first project tutorial](/blog/first-project) to see it in action. Need more installation options? See the [complete installation guide](/blog/installation-guide).
...
Installation Guide](/blog/installation-guide)[Next

First Project](/blog/first-project)

...
- Set up the main [Hooks Guide](/blog/hooks-guide) for complete hook coverage
- Configure the [Stop Hook](/blog/stop-hook-task-enforcement) to ensure task completion
- Try [Context Recovery](/blog/context-recovery-hook) to survive compaction
- Go deeper: Explore [skills](/blog/claude-skills-guide) for specialized agent workflows
...
Skill Activation Hook](/blog/skill-activation-hook)[Next

MCP Basics](/blog/mcp-basics)

...
Here's what trips people up: that `remaining_percentage` field includes the 16.5% autocompact buffer that you can't actually use. (This was previously 22.5% when the buffer was 45K tokens -- it was [recently reduced to 33K](/blog/context-buffer-management).)
...
Session Lifecycle](/blog/session-lifecycle-hooks)[Next

Skill Activation Hook](/blog/skill-activation-hook)

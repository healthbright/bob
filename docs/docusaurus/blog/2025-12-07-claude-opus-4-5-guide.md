...
Fewer tokens means faster responses, lower costs, and more headroom before hitting [context limits](/blog/context-preservation).
...
This matters when you're running parallel agents for testing, code generation, or [task distribution](/blog/task-distribution). Your primary agent orchestrates sub-agents more effectively:
...
Fix: Use `/compact` manually or break your task into smaller chunks. See [memory optimization](/blog/memory-optimization) for advanced patterns.
...
- Configure your [model selection strategy](/blog/choosing-the-right-claude-model) for when to use Opus vs Sonnet
- Learn [sub-agent design patterns](/blog/sub-agent-design) to maximize delegation
- Set up [efficiency patterns](/blog/efficiency-patterns) for production workflows
...
> **Update**: [Claude Opus 4.6](/blog/claude-opus-4-6) is now available with 1M token context and native agent teams. See the [complete model timeline](/blog) for all Claude models.

Last updated on

[Previous

Model Selection](/blog/choosing-the-right-claude-model)[Next

Claude Opus 4.6](/blog/claude-opus-4-6)

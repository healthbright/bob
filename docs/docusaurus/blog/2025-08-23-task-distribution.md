...
Master parallel task distribution by practicing with our [Sub-Agent Design](/blog/sub-agent-design) guide, then scale to advanced coordination with [Agent Fundamentals](/blog/agent-fundamentals).

For deciding between parallel, sequential, and background execution, see our [sub-agent best practices guide](/blog/sub-agent-best-practices).

For specific implementation patterns, check [Custom Agents](/blog/custom-agents) to create specialized task distributors for your development workflow.
...
Sub-Agent Design](/blog/sub-agent-design)[Next

Team Orchestration](/blog/team-orchestration)

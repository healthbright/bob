...
- Use [subagents](/blog/agent-fundamentals) or single sessions for routine tasks that don't need inter-agent communication
...
For real-world prompts you can copy and adapt, see [Agent Teams Use Cases and Prompt Templates](/blog/agent-teams-use-cases). For troubleshooting common issues and current limitations, see [Agent Teams Best Practices](/blog/agent-teams-best-practices).

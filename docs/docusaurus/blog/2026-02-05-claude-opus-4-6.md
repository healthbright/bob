...
In Claude Code, the standard 200K context window still applies. The 1M window is currently available through the API with a beta header. Your existing [context preservation strategies](/blog/context-preservation) remain relevant for day-to-day Claude Code work.
...
If you have been running Opus 4.5 and managing your [usage and costs](/blog/usage-optimization), the upgrade is pure upside at the same price.
...
For [model selection](/blog/choosing-the-right-claude-model), the calculus is simple. Use Opus 4.6 for complex work where reasoning depth matters. Use Sonnet for fast iteration on smaller tasks where speed trumps depth. The pricing parity means there is no cost reason to stay on the older model.

Last updated on

[Previous

Claude Opus 4.5 Guide](/blog/claude-opus-4-5-guide)[Next

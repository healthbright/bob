...
**New in 2026**: Claude Code now includes [MCP Tool Search](/blog/mcp-tool-search) - automatic lazy loading that reduces MCP context usage by up to 95%. Configure as many servers as you need without worrying about context limits.
...
Each MCP server unlocks specific capabilities. [Browse popular MCP servers](/blog/best-addons) to find ones matching your workflow.
...
2. **Explore popular options**: Check our [Popular MCP Servers guide](/blog/best-addons) for curated recommendations
3. **Set up browser automation**: Learn [browser automation with MCP](/blog/browser-automation) for advanced web interactions
4. **Create custom integrations**: Build your own MCP servers with our [Custom Integrations tutorial](/blog/custom-integrations)
...
Permission Hook](/blog/permission-hook-guide)[Next

MCP Tool Search](/blog/mcp-tool-search)

...
Check our [native installer guide](/blog/native-installer) for one-command setup, or the [complete installation guide](/blog/installation-guide) for all options.
...
Learn model selection strategies in our [model selection guide](/blog/choosing-the-right-claude-model).
...
Deep dive: [Claude Code vs Cursor comparison](/blog/claude-code-vs-cursor).
...
Master this powerful feature: [Claude Code Skills guide](/blog/claude-skills-guide).
...
Complete setup: [CLAUDE.md mastery guide](/blog/claude-md-mastery).
...
Detailed strategies: [usage optimization guide](/blog/usage-optimization).
...
See testing workflows: [feedback loops guide](/blog/feedback-loops).
...
Configuration deep dive: [configuration basics](/blog/configuration-basics). Full settings key reference: [settings reference](/blog/settings-reference).
...
Start building: [first project tutorial](/blog/first-project).
...
More fixes: [troubleshooting guide](/blog/troubleshooting).
...
Troubleshooting](/blog/troubleshooting)[Next

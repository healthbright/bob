...
**Problem**: You want to install Claude Code but don't know where to start. Here's the fastest path from zero to working AI terminal. See our [complete guide](/blog) for an overview of all Claude Code capabilities.
...
For details on what the native installer does and troubleshooting, see our [Native Installer Guide](/blog/native-installer).
...
> **Pilot Shell users on Windows**: Pilot requires a Unix environment. Install WSL2 (`wsl --install -d Ubuntu`), then run the Pilot installer inside your Ubuntu terminal.
...
1. **Build your first project**: [First Project Guide](/blog/first-project)
2. **Learn the interface**: [What is Claude Code](/blog/what-is-claude-code)
3. **Configure settings**: [Configuration Basics](/blog/configuration-basics)
4. **Fix common problems**: [Troubleshooting Guide](/blog/troubleshooting)
5. **See real examples**: [Examples & Templates](/blog/examples-templates)
...
What is Claude Code](/blog/what-is-claude-code)[Next

Native Installer](/blog/native-installer)

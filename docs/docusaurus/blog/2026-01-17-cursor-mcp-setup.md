...
Cursor MCP servers connect Cursor's AI to external tools, databases, and APIs through the [Model Context Protocol](/blog/mcp-basics). They work identically to MCP servers in Claude Code and Claude Desktop since they all use the same underlying protocol.
...
Automate browser testing, scraping, and visual verification. See our [browser automation guide](/blog/browser-automation) for advanced patterns.
...
Browse our [complete MCP servers list](/blog/best-addons) for 50+ additional options.
...
| **Tool search** | Not available | [Available](/blog/mcp-tool-search) |
| **Resources** | Not yet supported | Supported |

Claude Code's [MCP Tool Search](/blog/mcp-tool-search) provides lazy loading that reduces context usage by 95%. Cursor loads all configured MCP tools at session start.
...
3. **Explore automation**: Set up [browser automation](/blog/browser-automation) for testing
4. **Build custom servers**: Create MCP servers for your specific APIs and tools
5. **Browse all options**: Check the [complete MCP servers list](/blog/best-addons)
...
Extensions & Addons](/blog/best-addons)[Next

Search Tools](/blog/search-tools)

...
**Instruction-following and multimodal improvements.** Building on the [3.5 Sonnet v2](/blog/claude-3-5-sonnet-v2) gains, 3.7 Sonnet further improved at following complex, multi-constraint instructions. It also handled images, charts, and mixed media inputs with higher accuracy.
...
For a deeper look at how to use this effectively, see the [deep thinking techniques guide](/blog/deep-thinking-techniques).
...
Claude 3.7 Sonnet was the bridge between the 3.x and 4.x generations. The hybrid reasoning and extended thinking capabilities it pioneered became standard features in [Claude 4](/blog/claude-4) and every model that followed. If you are still running 3.7 Sonnet in production, the upgrade path to Claude 4 models is straightforward and the pricing remains competitive.

## [Navigation](#navigation)

- [All Claude Models](/blog) for the complete model index
- [Claude 3.5 Sonnet v2](/blog/claude-3-5-sonnet-v2), the October 2024 predecessor
- [Claude 4](/blog/claude-4), the next generation
- [Deep thinking techniques](/blog/deep-thinking-techniques) for getting the most out of extended thinking
- [Model selection strategies](/blog/choosing-the-right-claude-model) for choosing between Claude models

Last updated on

[Previous

Claude 4](/blog/claude-4)[Next

Claude 3.5 Sonnet v2](/blog/claude-3-5-sonnet-v2)

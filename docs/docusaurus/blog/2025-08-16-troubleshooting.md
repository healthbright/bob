...
See the [native installer guide](/blog/native-installer) for details.
...
For a complete walkthrough of the scope system, see our [configuration basics guide](/blog/configuration-basics#the-settingsjson-scope-system). For the full settings key reference, see the [settings reference](/blog/settings-reference).
...
For more on sandbox configuration, see our [sandboxing guide](/blog/permission-management).
...
For the full environment variable reference, see [configuration basics](/blog/configuration-basics#essential-environment-variables) or the [settings reference](/blog/settings-reference).
...
The [native installer](/blog/native-installer) handles PATH configuration automatically and includes auto-updates.
...
- Explore the [complete guide](/blog) for an overview of all features
- Set up your [first project](/blog/first-project) properly
- Learn [context management](/blog/context-management) to avoid future issues
- Configure [optimal settings](/blog/configuration-basics) for your workflow
- Switch to the [native installer](/blog/native-installer) for automatic updates
- Check our [installation guide](/blog/installation-guide) for platform-specific tips
- Review [common errors](/blog/faq) to prevent future problems

Last updated on

[Previous

Examples & Templates](/blog/examples-templates)[Next

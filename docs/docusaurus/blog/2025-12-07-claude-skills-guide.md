...
Unlike prompts (which disappear after each conversation) or [MCP servers](/blog/mcp-basics) (which connect to external tools), skills teach Claude *how to do things*. They encode procedural knowledge: workflows, guidelines, checklists, and domain expertise.
...
Skills use a two-stage loading system that saves your [context window](/blog/context-preservation):
...
**Key distinction**: Projects say "here's what you need to know." Skills say "here's how to do things." [MCP](/blog/mcp-basics) says "here's how to connect."
...
- [Git commit conventions](/blog/git-integration)
...
4. Explore [context management](/blog/context-management) to maximize your skill efficiency
...
Context Buffer Management](/blog/context-buffer-management)[Next

Dynamic Starting Context](/blog/claude-code-session-context)

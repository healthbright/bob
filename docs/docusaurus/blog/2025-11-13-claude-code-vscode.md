...
- **MCP support**: Use [MCP servers](/blog/mcp-basics) for browser automation and search
- **Extended thinking**: Toggle Claude's reasoning visibility for [deep thinking](/blog/deep-thinking-techniques)
- **Plan mode**: Review and edit Claude's [plans](/blog/planning-modes) before accepting changes

Your [first project](/blog/first-project) becomes faster when Claude edits files directly in your workspace.
...
Check your setup with our [installation guide](/blog/installation-guide). The extension also works with Cursor, Windsurf, and VSCodium.
...
Claude updates the same file with another diff. You maintain full control. Learn more in our [configuration basics](/blog/configuration-basics) guide.
...
Run separate Claude sessions per workspace folder - perfect for microservices. Each session maintains its own context. Learn about [agent workflows](/blog/agent-fundamentals) for advanced patterns.
...
For the full terminal optimization walkthrough, see the [terminal setup guide](/blog/terminal-setup-guide).
...
These are the defaults, but you can customize any shortcut through the [keybindings configuration](/blog/keybindings-guide).
...
See our [troubleshooting guide](/blog/troubleshooting) for more fixes.
...
- Try next: [MCP extensions](/blog/mcp-basics) for browser automation
- Go deeper: [Agent workflows](/blog/agent-fundamentals) for multi-step tasks
- Compare: [Claude Code vs Cursor](/blog/claude-code-vs-cursor)
- Configure: [Terminal setup](/blog/terminal-setup-guide) and [keyboard shortcuts](/blog/keybindings-guide) for your workflow
- Customize: [Settings reference](/blog/settings-reference) for all configuration options
...
Custom Integrations](/blog/custom-integrations)[Next

...
- **New to Claude Code?** Start with [Terminal Basics](/blog/terminal-main-thread) to understand the foundation
- **Ready for complex projects?** Learn [Context Management](/blog/context-management) for top-down success
- **Want efficiency?** Check [Planning Modes](/blog/planning-modes) for structured approaches
- **Building teams of agents?** Explore [Sub-Agent Design](/blog/sub-agent-design) for advanced coordination
- **Need systematic workflows?** See [Task Distribution](/blog/task-distribution) for managing complex projects
...
Custom Agents](/blog/custom-agents)[Next

Human-like Agents](/blog/human-like-agents)

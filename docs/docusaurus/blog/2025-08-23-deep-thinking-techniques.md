...
Add `alwaysThinkingEnabled` to your [settings.json](/blog/configuration-basics) to activate extended thinking for every response:
...
If you need fine-grained control over prompt caching, see the [model selection guide](/blog/choosing-the-right-claude-model) for per-model caching configuration.
...
4. **Use domain-specific [MCP extensions](/blog/mcp-basics)** for specialized tasks
...
**Advanced**: Learn [planning mode strategies](/blog/planning-modes) to structure extended thinking

**Optimization**: Explore [model selection](/blog/choosing-the-right-claude-model) to balance cost and performance

**Scaling**: Set up [custom agents](/blog/custom-agents) for specialized deep thinking tasks

**Troubleshooting**: Check our [performance optimization guide](/blog/speed-optimization) if deep thinking feels slow
...
Usage Optimization](/blog/usage-optimization)[Next

Context Preservation](/blog/context-preservation)

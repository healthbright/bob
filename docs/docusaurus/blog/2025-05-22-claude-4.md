---
slug: claude-4
title: "Claude 4: Sonnet 4 and Opus 4 Launch the Next Generation"
description: "Claude 4 launched May 2025 with Sonnet 4 and Opus 4. The generation that brought Claude Code mainstream with professional-grade coding capabilities."
authors: [max]
tags: [Reference, Models]
keywords: [4, claude, generation, launch, next, opus, sonnet]
---
...
## [What Claude 4 Brought to the Table](#what-claude-4-brought-to-the-table)
...
## [How It Compared to Claude 3.7](#how-it-compared-to-claude-37)
...
Sonnet 4 remains available through the API and can still be referenced by its model ID. Opus 4 has been superseded by [Opus 4.1](/blog/claude-opus-4-1), which improved on its reliability for production workflows.

For most users today, the [4.5 generation](/blog/claude-sonnet-4-5) is the recommended starting point. But Claude 4 deserves its place in the timeline as the generation that proved AI-assisted coding could be a serious engineering workflow.

## [Related Pages](#related-pages)

- [All Claude Models](/blog) for the complete model timeline
- [Opus 4.1](/blog/claude-opus-4-1) for the next Opus iteration
- [Model selection guide](/blog/choosing-the-right-claude-model) for choosing the right model today

Last updated on

[Previous

Opus 4.1](/blog/claude-opus-4-1)[Next

Claude 3.7 Sonnet](/blog/claude-3-7-sonnet)

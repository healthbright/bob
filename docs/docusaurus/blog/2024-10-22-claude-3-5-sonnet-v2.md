...
Both models have been superseded by newer generations, but they marked the moment Claude became more than a text generator. Computer Use was the proof of concept that led to increasingly sophisticated agentic capabilities in the [Claude 3.7 Sonnet](/blog/claude-3-7-sonnet) and [Claude 4](/blog/claude-4) releases.

## [Navigation](#navigation)

- [All Claude Models](/blog) for the complete model index
- [Claude 3.5 Sonnet](/blog/claude-3-5-sonnet), the original June 2024 release
- [Claude 3.7 Sonnet](/blog/claude-3-7-sonnet), the next generation with hybrid reasoning

Last updated on

[Previous

Claude 3.7 Sonnet](/blog/claude-3-7-sonnet)[Next

Claude 3.5 Sonnet](/blog/claude-3-5-sonnet)

...
Now when you ask Claude to commit, it follows your team's conventions automatically. Learn more in our [CLAUDE.md Mastery guide](/blog/claude-md-mastery).
...
When Claude Code creates git commits or pull requests, it adds attribution by default. This lets your team (and your future self) know which changes were AI-assisted. The `attribution` setting in your [settings.json](/blog/settings-reference) controls exactly what gets added.
...
The new `attribution` setting gives you finer control since you can disable commit attribution while keeping PR attribution, or vice versa. Place this in your [user, project, or local settings](/blog/settings-reference) depending on your needs.
...
- Set up [feedback loops](/blog/feedback-loops) for faster iteration
- Configure [todo workflows](/blog/todo-workflows) to track work
- Learn [planning modes](/blog/planning-modes) for complex changes
- Customize attribution and other options in the [settings reference](/blog/settings-reference)
- Optimize costs with [usage optimization](/blog/usage-optimization)
...
InfraOps VPS Guide](/blog/infraops-vps-guide)[Next

Permission Management](/blog/permission-management)
